...
The majority of this project--final feature definitions, refactored feature engineering, pipeline architecture and integration, modeling, evaluation, diagnostics, and final documentation--was designed and implemented by bellaBoecking

#### Additional Contributions:
[**tylrdnns**](https://github.com/tylrdnns): construction of the dataset; preliminary Supabase access setup; selection of raw features; early derived-feature calculations; core dataframe joins during early preprocessing; core logging scaffolding and application entry-point ('main') setup.
